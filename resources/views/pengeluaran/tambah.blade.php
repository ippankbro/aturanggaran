  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      ...
      <form action="pengeluarans" method='post'>
        ...
        <div class="form-floating mb-3">
          <input class="form-control @error('nominal') is-invalid @enderror" name="nominal" id="nominal " placeholder="nominal" value="{{old('nominal')}}">
