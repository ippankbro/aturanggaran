...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      ...
      <form action="pengeluarans/{{$pengeluaran->id}}" method='post'>
        @csrf
        @method('put')
        <div class="form-floating mb-3">
          <select class="form-select @error('sumber_id') is-invalid @enderror" name="sumber_id" id="sumber_id">
            @foreach ($sumbers as $sumber)
              @if (old('sumber_id',$pengeluaran->sumber_id) == $sumber->id)
        ...
        <div class="form-floating mb-3">
          <input class="form-control @error('nominal') is-invalid @enderror" name="nominal" id="nominal " placeholder="nominal" value="{{old('nominal',$pengeluaran->nominal)}}">
        ...
        <div class="form-floating mb-3">
          <input  class="form-control @error('catatan') is-invalid @enderror" name="catatan" id="catatan " placeholder="catatan" value="{{old('catatan',$pengeluaran->catatan)}}">
        ...
        <a class="btn btn-danger" href="pengeluarans" role="button">Batal</a>
